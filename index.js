...
if(score === 5){
  ...
  console.log("The difficuly of question has been increased. Get ready and let's play");

  var levelTwo = [ {
  question: "Whose power “exceeds that of the Sorcerer Supreme”? \n A. Captain America \n B. The Scarlet Witch \n C. Antman \n",
  answer: "B"
}, {
  question: "What is Carol Danver’s nickname for Monica Rambeau? \n A. Lieutenant Trouble \n B. Lieutenant Easy \n C. Lieutenant High \n",
  answer: "A"
}, {
...
console.log("***********************************\n\n");
  ...
  console.log("Sorry you could not reach level 2, your final score is "+score);
}
...
console.log("***********************************\n\n");
  ...
  console.log("Sorry you could not reach level 3, your final score is "+score);
}
